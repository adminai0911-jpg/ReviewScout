      ...
      <section className="max-w-4xl mx-auto px-6 mb-12">
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl shadow-2xl p-10 text-center text-white relative overflow-hidden">
          ...
          <form className="flex flex-col sm:flex-row max-w-xl mx-auto relative z-10" action="/api/subscribe" method="POST">
            <input type="email" name="email" placeholder="Enter your email address" className="flex-grow px-6 py-4 rounded-full sm:rounded-r-none text-slate-900 focus:outline-none focus:ring-2 focus:ring-indigo-400 mb-4 sm:mb-0 shadow-inner" required />
